...
__global__ void __cluster_dims__(8, 1, 1) __launch_bounds__(512) fwd_n128_a23_barrier_kernel(
    /*
    Kernel for specific case: n_neur = 128, a_dim = 2 or a_dim = 3
    ...
    */
    ...
    for (int t = 0; t < seq_len; ++t){
        ...
        auto token_bcast_r = tbc.barrier_arrive();
        // tbc.sync();
        ...
        // tbc.sync();
        tbc.barrier_wait(std::move(token_bcast_r));
